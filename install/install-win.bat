...
set "DLL_FILE=pg_fastbcp.dll"
set "CONTROL_FILE=pg_fastbcp.control"
set "SQL_FILE=pg_fastbcp--1.0.sql"

:: Welcome message and instructions
echo.
echo ==========================================================
echo           pg_fastbcp Installation Wizard
echo ==========================================================
echo.
...
if %errorlevel% equ 0 (
    :: Service is running, now check if files already exist.
    if "%files_exist%"=="true" (
        echo.
